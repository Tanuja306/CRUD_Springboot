    ...
    <form action="/updatedata" method="post" enctype="multipart/form-data">
        <div class="container">
          ...
          <p>Please fill in this form to create an account.</p>
            ...
            <input type="hidden" name="id" placeholder="Enter Username" value="${kk.id}" required>
      
              <label for="email"><b>Username</b></label>
            <input type="text" name="name" placeholder="Enter Username" value="${kk.name}" required>
          <label for="email"><b>Email</b></label>
          <input type="text" placeholder="Enter Email" name="email"value="${kk.email}" required>
          
          <label for="number"><b>Mobile number</b></label>
          <input type="phone" placeholder="Enter Number" name="number" value="${kk.number}"required><br>
          
          
          <label for="psw"><b>Password</b></label>
          <input type="password" placeholder="Enter Password" name="pass" value="${kk.pass}" required>
           ...
           <input type="radio" name="gender" value="female" >Female
            ...
            <img src="/images/${kk.filename}" height="50px" weight="100px">  
